    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-background flex items-center justify-center p-6">
      <div className="max-w-2xl w-full text-center space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8">
          <div className="p-6 bg-card/50 border-2 border-chart-1/30 rounded-md glow-purple">
            <h3 className="font-display font-semibold text-chart-1 mb-2">Enter Contest</h3>
            <p className="text-sm text-muted-foreground">
              Submit your costume and compete for the top spot
            </p>
          </div>
          <div className="p-6 bg-card/50 border-2 border-chart-2/30 rounded-md glow-blue">
            <h3 className="font-display font-semibold text-chart-2 mb-2">Vote</h3>
            <p className="text-sm text-muted-foreground">
              Support your favorite costumes with your vote
            </p>
          </div>
          <div className="p-6 bg-card/50 border-2 border-chart-3/30 rounded-md glow-orange">
            <h3 className="font-display font-semibold text-chart-3 mb-2">Live Rankings</h3>
            <p className="text-sm text-muted-foreground">
